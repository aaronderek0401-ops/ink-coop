...
void client_init() {
    ...
    Serial.write("zhangmeng\r\n");  // create some white space after ESP32 boot info
#else
    Uart0.setPins(TX, RX);  // Tx 1, Rx 3 - standard hardware pins
...
#if defined(LONGER_SCREEN_DBUG)
            if (client == CLIENT_SERIAL1) {
                Uart0.printf("DEC: %d, %c\n", data, data);
            }   
#endif
