...
namespace WebUI {
    ...
    static const char* DEFAULT_STA_SSID = "BLGS_2010810";
    ...
    static const char* DEFAULT_AP_SSID           = "BLGS_2010810";
...
#ifdef HTTP_PORT_8848
    static const int DEFAULT_WEBSERVER_PORT = 8848;
#else
